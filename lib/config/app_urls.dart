...
class AppUrls {
  ...
  static String loginWithFingerPrint =
      "$apiBaseUrl/auth/login/face-and-fingerprint";
...
class NotificationUrls {
  ...
  static String notificationsMarkAsRead =
      "${AppUrls.apiBaseUrl}/notification/mark-as-read";
  static String notificationsMarkAllAsRead =
      "${AppUrls.apiBaseUrl}/notification/mark-all-as-read";
}

class ProfileUrls {
  static String getProfile = "${AppUrls.apiBaseUrl}/profile";
  static String confirmPasswordAndGetSensitiveData =
      "${AppUrls.apiBaseUrl}/profile/confirm-password";
  static String updatePassword =
      "${AppUrls.apiBaseUrl}/profile/update-password";
  static String updateDefaultProfile =
      "${AppUrls.apiBaseUrl}/profile/update-default-password";
  static String updateProfilePhoto =
      "${AppUrls.apiBaseUrl}/profile/update-profile-photo";
}
...
class LocalAppUrl {
  ...
  static const String updateCompanyStatus =
      "$localWebApiUrl/companies/update-status";
  ...
  static const String getAttendanceStatus =
      "$localWebApiUrl/attendances-status";
  static const String addAttendanceStatus =
      "$localWebApiUrl/attendances-status/add";
  static const String addAttendanceTimeEntry =
      "$localWebApiUrl/time-entries/add";
  ...
  static const String addContractByClient =
      "$localWebApiUrl/client-contracts/add";
  static const String editContractByClient =
      "$localWebApiUrl/client-contracts/edit";
  static const String getContactByClient = "$localWebApiUrl/client-contacts";
  static const String addContactByClient =
      "$localWebApiUrl/client-contacts/add";
  static const String editContactByClient =
      "$localWebApiUrl/client-contacts/edit";
}
